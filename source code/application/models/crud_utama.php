...
class Crud_utama extends CI_Model {  
	...
	function baca_content($kode) //untuk membaca content berdasar kode buku harian
	...
	function baca_category1_tamu($account_name) //untuk membaca record buku harian yang tidak di publish buat tamu  
	...
	function baca_category_tamu($start,$per_page,$account_name) //untuk membaca seluruh record  
	...
	{  
		...
		$sql = $this->db->select('tb_bukuharian.id_bukuharian, tb_bukuharian.nama_bukuharian, tb_bukuharian.id_account, tb_bukuharian.status, tb_bukuharian.cover')
						...
						->order_by('tb_bukuharian.nama_bukuharian')
