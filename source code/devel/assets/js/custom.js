$(document).ready(function() {
	...
	$(".expand_custom a").click(function(e){
		...
		el.find('.custom .expand_custom').html('<img src="assets/img/preload.gif" alt="">');
		setTimeout(function() {
