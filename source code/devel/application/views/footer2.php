...
<script src="<?=base_url()?>js/jquery.peity.js"></script>
...
<script src="<?=base_url()?>js/plupload/jquery.plupload.queue/jquery.plupload.queue.js"></script>
...
<script src="<?=base_url()?>js/jquery.textareaCounter.plugin.js"></script>
<script src="<?=base_url()?>js/ui.spinner.js"></script>
<script src="<?=base_url()?>js/jquery.jgrowl_minimized.js"></script>
<script src="<?=base_url()?>js/jquery.form.js"></script>
<script src="<?=base_url()?>js/jquery.validate.min.js"></script>
<script src="<?=base_url()?>js/bbq.js"></script>
<script src="<?=base_url()?>js/jquery-ui-1.8.22.custom.min.js"></script>
<script src="<?=base_url()?>js/jquery.form.wizard-min.js"></script>
